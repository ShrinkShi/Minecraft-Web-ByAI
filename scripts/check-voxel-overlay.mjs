...
const stateData=new Uint8Array(CHUNK_SIZE*CHUNK_SIZE*64),stateCalls=[],sidecar=createBlockStateSidecar(),stateWorld={chunks:new Map([['0,0',stateData]]),edits:new Map(),blockStates:sidecar,index,requestMesh:(x,z)=>stateCalls.push(`${x},${z}`)},stateIndex=index(2,20,3);stateData[stateIndex]=BLOCK.LOG;
