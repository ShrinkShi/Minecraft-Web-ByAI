...
const infoState=(session,overrides={})=>({session,worldId:'world-main',terrainVersion:TERRAIN_GENERATOR_VERSION,seed:'世界种子',prompt:'森林',tickRate:20,...overrides});
