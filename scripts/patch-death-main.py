...
replace_once(old_animate,new_animate,'animate death freeze')

if 'respawnPlayer(' in text:
    raise SystemExit('legacy respawnPlayer reference remains')
path.write_text(text,encoding='utf-8')
print('death main patch: PASS')
