...
const blockEntry=Object.entries(ITEMS).find(([,definition])=>Number.isInteger(definition?.blockId));
...
console.log('three-face terrain-atlas block item preview contract: PASS');
