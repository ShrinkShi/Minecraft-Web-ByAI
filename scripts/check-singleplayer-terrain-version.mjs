...
assert.equal(resolveSingleplayerTerrainVersion({version:9,terrainVersion:3}),3,'existing terrain-v3 worlds stay pinned after v4 ships');
assert.equal(resolveSingleplayerTerrainVersion({version:9,terrainVersion:4}),4);
...
assert.throws(()=>resolveSingleplayerTerrainVersion({version:9,terrainVersion:5}),/unsupported terrain generator version/);
...
console.log('singleplayer terrain pinning: legacy=v2, existing v3 preserved, new worlds=v4, save schema remains v9: PASS');
