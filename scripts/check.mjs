...
function testCommands(){
  ...
  const ctx={player:p,inventory,inventoryChanged(){},setMode:v=>mode=v,setSpawnpoint:(x,y,z)=>(spawnpoint={x,y,z},true),addXp:v=>addedXp+=v,kill:()=>killed=true,teleport:(x,y,z)=>p.position={x,y,z},setTime:v=>time=v,setWeather:v=>weather=v};
