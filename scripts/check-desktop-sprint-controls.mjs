...
const controls=new DesktopControls(canvas,bus);const event=(code,timeStamp,{repeat=false}={})=>({code,timeStamp,repeat,preventDefault(){}});
...
console.log('desktop Ctrl + double-W sprint + gameplay-gated drop integration: PASS');
