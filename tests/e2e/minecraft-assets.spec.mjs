...
test('imported Minecraft runtime assets resolve and decode through the real HTTP server',async({page,request})=>{
  ...
  expect(Object.keys(modelManifest.textures)).toHaveLength(29);expect(modelManifest.textures['minecraft:block/grass']).toBeTruthy();expect(modelManifest.textures['minecraft:block/glass']).toBeTruthy();expect(modelManifest.textures['minecraft:block/farmland']).toBeTruthy();expect(modelManifest.textures['minecraft:block/farmland_moist']).toBeTruthy();expect(modelManifest.textures['minecraft:block/wheat_stage7']).toBeTruthy();
