...
test('eight iron ingots craft and equip a source-backed iron chestplate',async({page})=>{
  ...
  expect(browserContract).toEqual({durabilities:[165,240,225,195],points:15,beforeHead:{id:'iron_helmet',count:1,damage:4},wear:2,afterHead:{id:'iron_helmet',count:1,damage:6},damage10:6});
