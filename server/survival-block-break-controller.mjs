...
export class SurvivalBlockBreakController{
  ...
  step(session,player,selectedStack=null,{dt=DEFAULT_SURVIVAL_MINING_DT}={}){
    ...
    if(progress<1){this.progressBySession.set(session,{key:targetKey,target:{...target},progress});return outcome({attempted:true,reason:previous?.key===targetKey?'mining':'target-acquired',progress,target,breakResult:null,drop:null});}
