...
function inventoryLike(value){if(!value||typeof value!=='object'||typeof value.selectedStack!=='function'||typeof value.commitSelected!=='function')throw new TypeError('inventories must expose selectedStack and commitSelected');return value;}
