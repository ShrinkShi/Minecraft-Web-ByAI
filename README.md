...
> 稳定发布基线：`v0.3.0`。当前 `main` 开发线为 `v0.4.0-dev`：实体数据层、第一批被动生物、僵尸、骷髅、苦力怕、蜘蛛、基础战斗、箭矢、爆炸、战利品/经验和基础生存死亡损失已经落库；护甲、水/氧气、天气粒子等仍属于后续工作，未完成前不会计入版本完成度。
...
- 生存/冒险死亡：36 格背包、cursor 和 2×2/3×3 合成输入统一清算；普通死亡把物品掉在死亡点，并掉落 `min(100, 当前等级 × 7)` 点经验后清零总经验。
...
- 后续：死亡界面/统计与床重生、护甲/完整伤害公式、水与氧气、天气粒子、状态效果、附魔、村民交易、酿造、维度、结构、多人生存网络层、真正 AI 地形管线。
