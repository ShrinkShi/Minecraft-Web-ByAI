...
export const HOSTILE_MOBS=Object.freeze({
  ...
  spider:Object.freeze({name:'蜘蛛',hp:16,speed:2.05,width:1.4,height:.9,color:0x332a2a,accent:0xb3262f,model:'spider',followRange:16,attackStyle:'melee',attackRange:1.6,attackDamage:2,attackCooldown:.8,climbRate:3.2,maxClimbHeight:3,loot:Object.freeze([loot('string',0,2)]),xp:[5,5]})
});
