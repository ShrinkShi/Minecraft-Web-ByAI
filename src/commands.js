...
export const ITEM_ALIASES={
  ...
  glass:'block:20','minecraft:glass':'block:20',furnace:'block:21','minecraft:furnace':'block:21',
  stick:'stick','minecraft:stick':'stick',wooden_pickaxe:'wooden_pickaxe','minecraft:wooden_pickaxe':'wooden_pickaxe',
  raw_iron:'raw_iron','minecraft:raw_iron':'raw_iron',iron_ingot:'iron_ingot','minecraft:iron_ingot':'iron_ingot',
