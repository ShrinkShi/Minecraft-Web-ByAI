...
export class RemotePlayerSystem{
  constructor(scene,{tickRate=20}={}){
    ...
    this.materials={skin:new THREE.MeshLambertMaterial({color:0xc98f68}),shirt:new THREE.MeshLambertMaterial({color:0x3f87a6}),pants:new THREE.MeshLambertMaterial({color:0x334c7a})};this.disposed=false;
  }
