...
function cloneInventory(value){return value?{...value,slots:value.slots.map(slot=>slot?{...slot}:null),cursor:value.cursor?{...value.cursor}:null}:null;}
