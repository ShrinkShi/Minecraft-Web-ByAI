...
export class MultiplayerMovementSession{
  ...
  handleMiningProgress(message){const copy=cloneMiningProgress(message);this.latestMiningProgress=copy;this.onMiningProgress(cloneMiningProgress(copy));return copy;}
