...
export const ITEMS={
  ...
  raw_chicken:textured('生鸡肉',64,'item.raw_chicken',{color:0xe5c39f,food:{nutrition:2,saturationModifier:.3,effects:[{id:'hunger',amplifier:0,durationSeconds:30,chance:.3}]}}),
  ...
  rotten_flesh:textured('腐肉',64,'item.rotten_flesh',{color:0x8d613a,food:{nutrition:4,saturationModifier:.1,effects:[{id:'hunger',amplifier:0,durationSeconds:30,chance:.8}]}}),
