...
export class PassiveMobSystem{
  constructor(scene,world,{maxEntities=16,cellSize=8,onDeath=()=>{}}={}){
    ...
    this.resources={geometries:new Set(),materials:new Set(),textures:new Set(),textureCache:new Map(),materialCache:new Map()};this.templates=new Map();
    for(const[type,def]of Object.entries(PASSIVE_MOBS))this.templates.set(type,createMobModelTemplate(type,def,this.resources));
  }
