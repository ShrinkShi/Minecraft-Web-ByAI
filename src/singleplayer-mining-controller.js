...
export class SingleplayerMiningController{
  constructor({aim,getMode,getSelectedStack,breakTarget,spawnDrop,damageSelected,onProgress=()=>{},onBreak=()=>{}}={}){
    ...
    this.held=false;this.startedAt=0;this.lastAt=0;this.hasStepped=false;this.target=null;this.key=null;this.progress=0;
  }

  start(now){now=finite(now,'mining start time');this.held=true;this.startedAt=now;this.lastAt=now;this.hasStepped=false;this.target=null;this.key=null;this.progress=0;this.onProgress(0);return this.snapshot();}
  cancel(){this.held=false;this.startedAt=0;this.lastAt=0;this.hasStepped=false;this.target=null;this.key=null;this.progress=0;this.onProgress(0);return this.snapshot();}
