...
export class ProjectileSystem{
  ...
  createArrowVisual(){
    const group=new THREE.Group();group.userData.projectileModel='item.arrow';const a=new THREE.Mesh(this.arrowGeometry,this.arrowMaterial),b=new THREE.Mesh(this.arrowGeometry,this.arrowMaterial);a.rotation.z=-Math.PI/4;b.rotation.set(0,Math.PI/2,-Math.PI/4);group.add(a,b);return group;
  }
